...
//
// Cambios v3:
// · Bug 1.5 — campo `change24h` renombrado a `changeSession`. El valor representa
//   cambio % desde el primer tick que recibió ESTE navegador en esta sesión
//   (resetea al recargar), NO cambio real de 24h.
