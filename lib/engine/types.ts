...
export interface SessionLevels {
  ...
  pdc: number | null;  // Previous Day Close — para calcular pivotes clásicos
}
...
export interface StructureLevels {
  ...
  slPct:      number;
  tpPct:      number;
  tpSource:   "session" | "structure" | "fallback" | "pivot"; // NEW — origen del TP
}
...
export interface RawSignal {
  ...
  slPrice:   number;
  tpPrice:   number;
  tpSource:  "session" | "structure" | "fallback" | "pivot";
