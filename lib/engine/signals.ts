...
export function htfSignalAt(ind: PrecomputedIndicators, i: number): HTFResult {
  ...
  // Bug 3.2: diferencia mínima de 2 puntos para emitir señal
  // Evita señales mixtas frágiles (ej: 3-2 o 4-3 que antes pasaban como UP)
...
export function mtfSignalAt(ind: PrecomputedIndicators, i: number): SignalDirection {
  ...
  // Bug 3.2: misma regla de diferencia mínima 2 en MTF/LTF
