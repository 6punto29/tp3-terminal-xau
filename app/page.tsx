...
export default function HomePage() {
  ...
  return (
    <div style={{ display:"flex", flexDirection:"column",
      // PWA standalone iOS: el scroll-lock en globals.css congela html/body
      // (position:fixed), así que el viewport no se extiende durante el scroll.
      // El root llena ese viewport fijo con height:100%.
