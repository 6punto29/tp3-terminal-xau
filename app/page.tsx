      ...
      <div style={{
        ...
        <div style={{ display:"flex", gap:10, alignItems:"center" }}>
          ...
          {/* B.10: botón de notificaciones — visible en desktop Y mobile.
              ...
              La diferenciación entre estados viene SOLO del emoji (🔔 vs 🔕) y
              del tooltip — sin halo coloreado para mantener limpio el topbar. */}
          <button
            ...
            style={{
              background:"transparent", border:"1px solid var(--tp3-border2)",
              borderRadius:6, padding:"4px 8px", cursor:"pointer",
              fontSize:14, lineHeight:1, color:"var(--tp3-muted)",
            }}
          >
            {notifPerm === "granted" ? "🔔" : "🔕"}
          </button>
