...
function Section1() {
  ...
  const [minRatio, setMinRatio] = useState(1.5);   // umbral TP/SL (default 1.5 = comportamiento histórico)
  const [atrMin,   setAtrMin]   = useState(0);     // ATR mínimo (0 = sin filtro)
    ...
    <BtCard>
      ...
      <div style={{
        ...
        <span style={{ fontFamily: SANS, fontSize: 7, color: T.dim,
          marginLeft: 6 }}>
          (defaults: 1.5× / OFF — comportamiento histórico)
        </span>
      </div>
