...
export default function CuentaDashboard({userId}:{userId:string}){
  ...
  const calidadStats=[
    ...
    {l:"Desv. R",         v:stdR==null?"--":`${stdR.toFixed(2)}R`,  c:T.text,                                                                              sub:"dispersión de R"},
    ...
    {l:"MAE prom. gan.",  v:maeWinAvg==null?"--":`${maeWinAvg.toFixed(2)}%`,     c:T.text,                                                                  sub:"aguante de ganadoras"},
  ];
  ...
  const copyStats = async()=>{
    ...
    const text = [
      ...
      `  Desv. R:         ${stdR==null?"--":`${stdR.toFixed(2)}R`}`,
      ...
      `  MAE prom. gan.:  ${maeWinAvg==null?"--":`${maeWinAvg.toFixed(2)}%`}`,
      "",
                ...
                return (
                  <div style={{background:T.s2,border:`1px solid ${T.border2}`,borderRadius:10,padding:14,marginTop:16,marginBottom:8}}>
                    ...
                    <div style={{display:"grid",gridTemplateColumns:"repeat(5, 1fr)",gap:10}}>
                      ...
                      <div>
                        <div style={{fontFamily:SANS,fontSize:8,color:T.muted,textTransform:"uppercase",letterSpacing:"0.04em",marginBottom:3}}>Aciertos</div>
                      ...
                      <div>
                        <div style={{fontFamily:SANS,fontSize:8,color:T.muted,textTransform:"uppercase",letterSpacing:"0.04em",marginBottom:3}}>Avg PnL</div>
                        <div style={{fontFamily:MONO,fontSize:16,fontWeight:700,color:s.avgPnl!=null?(s.avgPnl>=0?T.up:T.down):T.muted}}>
                          {fmtPct(s.avgPnl)}
                        </div>
                      </div>
                      <div>
