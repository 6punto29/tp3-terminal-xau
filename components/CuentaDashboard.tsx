  ...
  return(
    <div style={{background:T.bg,minHeight:"100%",padding:"16px",overflowY:"auto"}}>
      <div style={{maxWidth:1100,margin:"0 auto",display:"flex",flexDirection:"column",gap:14}}>
        ...
        {/* Reglas de gestión — línea compacta */}
        <div style={{padding:"6px 12px",borderRadius:7,background:T.s1,border:`1px solid ${T.border}`,
          fontFamily:SANS,fontSize:10,color:T.muted,lineHeight:1.4,display:"flex",alignItems:"center",flexWrap:"wrap",gap:"0 6px"}}>
          <span style={{color:T.gold,fontWeight:700,marginRight:4}}>Reglas</span>
          📊 Máx 2 ops/sesión · 🛑 2 SL seguidos = cerrar · 💰 Riesgo 1% · ⏱ LDN/NY únicamente · 🎯 Score ≥6 · 📰 Sin noticias 30M · ✅ Checklist verde
          <span style={{marginLeft:6,color:T.gold,fontSize:9}}>· EV +1.55R · WR 51% · 81 señales</span>
        </div>
                    ...
                    {op.resultado==null?(
                      ...
                      <>
                        ...
                        <div>
                          ...
                          {rMult!=null&&(
                            <div style={{fontFamily:MONO,fontSize:9,color:T.dim}}>
