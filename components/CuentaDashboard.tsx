            ...
            <>
              ...
              {shadowExpanded && (
                <div style={{marginTop:8,display:"flex",flexDirection:"column",gap:3,maxHeight:400,overflowY:"auto"}}>
                  <div style={{display:"grid",gridTemplateColumns:"80px 100px 50px 70px 70px 70px 100px 70px 70px",gap:6,
                    padding:"4px 8px",fontFamily:SANS,fontSize:8,fontWeight:600,
                  ...
                  {shadowTrades.map(t=>{
                    ...
                    return(
                      <div key={t.id} style={{display:"grid",gridTemplateColumns:"80px 100px 50px 70px 70px 70px 100px 70px 70px",gap:6,
                        padding:"5px 8px",borderRadius:5,background:T.s2,alignItems:"center",
