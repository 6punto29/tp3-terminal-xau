...
function EntryValidityIndicator({
  ...
  // D1 + HTF + MTF todos a favor del trade. Si todos coinciden, ignora tiempo
  // y dispara 🟢 mientras R:R sea válido.
  const trendOverride =
    d1Bias===tradeDir &&
    signal.htf===tradeDir &&
    signal.mtf===tradeDir;
...
function MT5Block({signal,score,price,slPct,tpPct,refreshKey,htfTf,d1Bias}:MT5BlockProps){
  ...
  return(
    <Card style={{marginBottom:4,padding:"8px 10px",border:`1px solid ${color}40`,background:`${color}08`}}>
      ...
      {/* Semáforo adaptativo de validez de entrada */}
      <EntryValidityIndicator signal={signal} price={price} htfTf={htfTf} d1Bias={d1Bias}/>
    ...
    <>
      ...
      <div className="tp3-root" style={{fontFamily:SANS,color:T.text,background:T.bg}}>
        ...
        <div className="tp3-main"
          ...
          <MT5Block signal={signal} score={signalScore} price={price} slPct={slPct} tpPct={tpPct} refreshKey={capRiskKey} htfTf={htfTf} d1Bias={d1Bias}/>
          <Card>
