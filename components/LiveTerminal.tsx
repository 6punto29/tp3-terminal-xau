...
export default function LiveTerminal({userId,price,connected,notifPerm}:{userId:string;price:number;connected:boolean;notifPerm:"default"|"granted"|"denied"}){
  ...
  },[signal,signalScore,price,notifPerm]);
  // ───────────────────────────────────────────────────────────────────────────
    ...
    <>
      <style>{`
        ...
        @media(max-width:700px){
          ...
          .tp3-root{grid-template-columns:1fr;flex:1;min-height:0;height:auto;}
          .tp3-sidebar,.tp3-main,.tp3-right{grid-column:1;grid-row:1;overflow-y:auto;height:auto;max-height:none;}
