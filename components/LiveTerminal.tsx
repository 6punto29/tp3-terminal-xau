  ...
  return(
    <>
      <style>{`
        ...
        .tp3-root{display:grid;grid-template-columns:1fr 1.3fr;grid-template-rows:1fr;height:100%;width:100%;max-width:1200px;margin:0 auto;overflow:hidden;padding:0 24px;box-sizing:border-box;}
        ...
        @media(max-width:700px){
          ...
          .tp3-root{grid-template-columns:1fr;padding:0;max-width:none;margin:0;}
        ...
        @media(orientation:landscape) and (max-height:500px){
          .tp3-root{grid-template-columns:1fr 1fr!important;max-width:none;}
