      ...
      <div className="tp3-root" style={{fontFamily:SANS,color:T.text,background:T.bg}}>
        ...
        <div className={`tp3-sidebar${mobileTab==="estado"?" mob-active":""}`}
          ...
          <Card style={{marginBottom:6}}>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:4}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"4px 7px",borderRadius:5,background:T.s2}}>
                <div>
                  ...
                  <div style={{fontFamily:MONO,fontSize:8,color:T.muted}}>Binance Spot · REST 2s</div>
                </div>
            ...
            {ws.high24h>0&&(
              <div style={{display:"flex",justifyContent:"space-between",marginTop:6,padding:"3px 7px",borderRadius:4,background:T.s2}}>
                <span style={{fontFamily:MONO,fontSize:8,color:T.up}}>H {ws.high24h.toFixed(2)}</span>
                <span style={{fontFamily:MONO,fontSize:8,color:T.muted}}>24h</span>
                <span style={{fontFamily:MONO,fontSize:8,color:T.down}}>L {ws.low24h.toFixed(2)}</span>
              </div>
            )}
