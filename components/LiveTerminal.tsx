  ...
  return(
    <>
      <style>{`
        ...
        .tp3-root{display:grid;grid-template-columns:1fr 1fr;grid-template-rows:1fr;height:100%;width:100%;max-width:1400px;margin:0 auto;gap:24px;overflow:hidden;padding:0 24px;box-sizing:border-box;}
        ...
        @media(max-width:700px){
          ...
          .tp3-root{grid-template-columns:1fr;padding:0;gap:0;}
        ...
        @media(orientation:landscape) and (max-height:500px){
          .tp3-root{grid-template-columns:1fr 1fr!important;gap:8px!important;padding:0 8px!important;}
