...
interface EditModalProps{
  op:Operation;
  onClose:()=>void;
  onSave:(updated:{id:string;direccion:Direction;precio_entrada:number;sl:number;tp:number;lotaje:number|null;resultado:OpsResult;pnl:number|null;hora_apertura_mt5:string|null})=>void;
}
