...
export default function LiveTerminal({userId,price,connected,notifPerm,requestNotif,notifEnabled}:{userId:string;price:number;connected:boolean;notifPerm:"default"|"granted"|"denied";requestNotif:()=>Promise<void>;notifEnabled:boolean}){
