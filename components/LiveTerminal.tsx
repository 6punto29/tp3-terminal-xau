      ...
      <div className="tp3-root" style={{fontFamily:SANS,color:T.text,background:T.bg}}>
        ...
        <div className="tp3-topbar" style={{display:"flex",alignItems:"center",justifyContent:"space-between",
          ...
          <div style={{display:"flex",gap:10,alignItems:"center"}}>
            ...
            {ws.high24h>0&&<span style={{fontFamily:MONO,fontSize:9,color:T.muted}}>H {ws.high24h.toFixed(0)} / L {ws.low24h.toFixed(0)}</span>}
        ...
        <div className={`tp3-sidebar${mobileTab==="estado"?" mob-active":""}`}
          ...
          <Card style={{marginBottom:6}}>
            ...
            <div style={{display:"flex",alignItems:"center",gap:6,marginBottom:4}}>
              ...
              <span style={{fontFamily:SANS,fontSize:11,color:T.muted}}>{ws.connected?"Binance Futures WS":"Desconectado"}</span>
            </div>
