          ...
          <div key={op.id}>
            ...
            {op.resultado!=null&&(
              <div style={{display:"flex",alignItems:"center",gap:10,padding:"4px 10px",
                ...
                {rMultiple!=null&&(
                  <div>
                    <div style={{fontSize:7,color:T.muted,letterSpacing:"0.05em",textTransform:"uppercase"}}>R</div>
                    <div style={{fontFamily:MONO,fontSize:12,fontWeight:700,color:pnlColor}}>
                ...
                {/* % precio */}
                <div>
                  <div style={{fontSize:7,color:T.muted,letterSpacing:"0.05em",textTransform:"uppercase"}}>Δ precio</div>
