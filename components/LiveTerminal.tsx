...
function MT5Block({signal,score,price,slPct,tpPct,refreshKey,htfTf}:MT5BlockProps){
    ...
    <>
      ...
      <div className="tp3-root" style={{fontFamily:SANS,color:T.text,background:T.bg}}>
        ...
        <div className="tp3-main"
          ...
          <MT5Block signal={signal} score={signalScore} price={price} slPct={slPct} tpPct={tpPct} refreshKey={capRiskKey} htfTf={htfTf}/>
          <Card>
