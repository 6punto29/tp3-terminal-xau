...
export default function LiveTerminal({userId,price,connected,notifPerm,requestNotif}:{userId:string;price:number;connected:boolean;notifPerm:"default"|"granted"|"denied";requestNotif:()=>Promise<void>}){
  ...
  //
  // B.9 (04/06/26): notifPerm y requestNotif se liftearon a app/page.tsx y
  // llegan acá como props. Esto prepara el terreno para que el toggle 🔔 del
  // topbar (B.10) pueda leer/escribir el permiso desde el componente padre.
