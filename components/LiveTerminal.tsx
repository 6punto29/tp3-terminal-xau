...
function MobileBottomNav({active,onChange}:{active:MobileTab;onChange:(t:MobileTab)=>void}){
  ...
  // (CSS controla display según data-mobile-tab del root), pero los 3 siguen
  // montados en el DOM. Registramos el listener en los 3 — el inactivo
  // simplemente no dispara scroll.
  useEffect(() => {
    const THRESHOLD = 50;
    const TOP_GUARD = 30;
